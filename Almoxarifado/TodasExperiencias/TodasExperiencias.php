...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="TodasExperiencias.css">
    ...
    <body>
        ...
        <div class="container-fluid row">
            <div class="col-lg-6 restaurant-full-details">
                ...
                </div></a>                <a class="hyperlink-restaurant-list" href="../PaginaDeRestaurante/restaurantes.php"><div class="restaurant-list row">
                    <div class="col-lg-8">
                        <div class="restaurant-list-text">
                            <div class="restaurant-name">
                                <span class="restaurant-name">Chef Thiago Bullara ensina brownie da familia</span>
